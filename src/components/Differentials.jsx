    ...
    <section className="mt-[2rem] flex justify-center items-center relative">
      <div className="flex flex-col w-[85%] mb-[3rem]">
        ...
        <div className="flex flex-col items-center justify-center mt-[2rem] gap-y-[1rem]">
          <div className="p-[1px] bg-[#FFFFFF4D] rounded-2xl w-[100%] overflow-hidden">
            <div className="bg-[#100a2e]/90 h-[13.5rem] backdrop-blur-md py-[1rem] items-center justify-center rounded-2xl text-[white] flex flex-col">
              ...
              <div className="flex flex-col w-[82%] h-[12.3rem] justify-center">
                ...
                <p className="text-white text-[12.9px] font-[300] mt-[1.2rem]">
                  ...
                  aposta com insights gerados por dados avançados, sobre quando,
                  onde e como apostar para ganhar.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#100a2e]/90 h-[13.5rem] backdrop-blur-md py-[1rem] relative items-center justify-center rounded-2xl text-[white] flex flex-col">
              ...
              <div className="flex flex-col h-[12.3rem] w-[82%] justify-center relative">
                ...
                <p className="text-white text-[12.9px] font-[300] mt-[1.2rem]">
                  ...
                  O TipMiner desvenda os segredos dos maiores dos jogos online,
                  oferecendo análises tão profundas que você sentirá como se
                  pudesse prever o futuro. Cada movimento é uma jogada calculada
                  rumo à riqueza.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#100a2e]/90 h-[13.5rem] backdrop-blur-md py-[1rem] items-center justify-center rounded-2xl text-[white] flex flex-col">
              ...
              <div className="flex flex-col w-[82%] h-[12.3rem] justify-center">
                ...
                <p className="text-white text-[12.9px] font-[300] mt-[1.2rem]">
                  ...
                  desenvolvida com o máximo de excelência e eficácia, desenhada
                  para acertar os resultados com base em dados e análise de
                  padrões.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#100a2e]/90 h-[13.5rem] backdrop-blur-md py-[1rem] items-center justify-center rounded-2xl text-[white] flex flex-col">
              ...
              <div className="flex flex-col w-[82%] h-[12.3rem] justify-center">
                ...
                <p className="text-white text-[12.9px] font-[300] mt-[1.2rem]">
                  ...
                  estratégia. Com o TipMiner, você está sempre um passo à
        ...
        <a className="text-[white] mt-[1rem] text-[14px] text-center px-[1.3rem] py-[0.8rem] rounded-md font-[600] bg-gradient-to-r from-[#02C1E3] to-[#0412E7]">
        ...
        <img
          src={Elipse2Img}
          alt=""
          className="absolute left-0 bottom-2 w-[100%]"
        />
      </div>
    </section>
  );
